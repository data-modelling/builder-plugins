...
var JsonViewPlugin = /*#__PURE__*/function (_Component) {
  _inherits(JsonViewPlugin, _Component);

  var _super = _createSuper(JsonViewPlugin);

  function JsonViewPlugin() {
    _classCallCheck(this, JsonViewPlugin);

    return _super.apply(this, arguments);
  }

  _createClass(JsonViewPlugin, [{
    key: "render",
